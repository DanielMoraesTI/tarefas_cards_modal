...
export class TagService {
     ...
     */
    public async getTags(taskId: number): Promise<any[]> {
        try {
     ...
     * @returns Tag criada
     */
    public async createTag(name: string, color: string = '#9b59b6'): Promise<any> {
        try {
     ...
     */
    public async addTag(taskId: number, tagId: number): Promise<void> {
        try {
     ...
     */
    public async getTasksByTag(tagId: number): Promise<any[]> {
        try {
