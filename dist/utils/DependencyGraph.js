...
export class DependencyGraph {
     ...
     */
    getAllDependencies(item, visited = new Set()) {
        const allDeps = [];
        visited.add(item);
     ...
     */
    hasCycle(item, visited = new Set(), recursionStack = new Set()) {
        visited.add(item);
