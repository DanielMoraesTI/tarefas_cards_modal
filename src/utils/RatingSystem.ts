...
export class RatingSystem<T> {
     ...
     */
    getDistribution(item: T): Record<number, number> {
     ...
     */
    getByMinAverage(threshold: number): T[] {
        return Array.from(this.ratings.keys())
